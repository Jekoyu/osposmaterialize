...
class Reports extends Secure_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('reports/listing2', $data);
	}
	...
	public function summary_discounts_input()
	{
		...
		$this->load->view('reports/date_input2', $data);
	}
	...
	public function date_input_sales()
	{
		...
		// additional custom report > employee
		$data['employees_filter'] = 1;
		$data['employees'] = array('all'=>'Semua');
	...
	public function graphical_summary_expenses_categories($start_date, $end_date, $sale_type)
	{
		...
		$this->load->view('reports/graphical2', $data);
	}
	...
	public function specific_customer($start_date, $end_date, $customer_id, $sale_type, $payment_type)
	{
		...
		$this->load->view('reports/tabular_details2', $data);
	}
	...
	public function detailed_sales($start_date, $end_date, $sale_type, $location_id = 'all', $disc_type=0,$employee_id='all')
	{
		// cek($employee_id);
		// die();
		$definition_names = $this->Attribute->get_definitions_by_flags(Attribute::SHOW_IN_SALES);

		$inputs = array('start_date' => $start_date, 'end_date' => $end_date, 'sale_type' => $sale_type, 'location_id' => $location_id, 'definition_ids' => array_keys($definition_names),'employee_id'=>$employee_id);
	...
	public function inventory_summary_input()
	{
		...
		$this->load->view('reports/inventory_summary_input2', $data);
	}
