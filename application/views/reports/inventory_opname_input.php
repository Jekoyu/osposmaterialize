	                ...
	                <div class="panel panel-inverse">
	                    ...
	                    <div class="panel-body">
							...
							<?php echo form_open('#', array('id'=>'item_form', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')); ?>
								...
								<div class="form-group form-group-sm">
									<?php echo form_label('Kategori', 'reports_kategori_label', array('class'=>'required control-label col-xs-2')); ?>
									<div id='report_item_count' class="col-xs-3">
										<?php echo form_dropdown('category',$category,'all','id="category" class="form-control"'); ?>
									</div>
								</div>
							...
							$(document).ready(function()
							{
								...
								{
									window.location = [window.location, $("#location_id").val(), $("#item_count").val(), $("#category").val()].join("/");
								});
							});
							</script>
							<!-- ./original ospos -->
