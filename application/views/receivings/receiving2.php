			    ...
			    <div class="col-md-12">
	                <div class="panel panel-inverse">
	                    ...
	                    <div class="panel-body">
							...
							?>
							<div class="row">
								<div id="register_wrapper" class="col-md-9">
									...
									<?php echo form_open($controller_name."/add", array('id'=>'add_item_form', 'class'=>'form-horizontal panel panel-default')); ?>
										<div class="panel-body form-group">
											<ul>
												...
												<li class="pull-left" style="width: 245px;">
								...
								<!-- Receiving Items List -->
									...
									<div class="table-responsive">
										<table class="sales_table_100 table table-sm table-nonfluid" id="register">
										<thead>
											<tr>
													...
													<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
														<tr>
															...
															?>
																<td>
																<div class="input-group">
																	<?php echo form_input(array('name'=>'discount', 'class'=>'form-control input-sm p-3', 'value'=>to_decimals($item['discount'], 0), 'onClick'=>'this.select();')); ?>
																	<span class="input-group-btn">
														...
														<tr>
															...
															<td colspan='2' style="text-align: left;">
																...
																if($item['allow_alt_description']==1)
																{
																	echo form_input(array('name'=>'description', 'class'=>'form-control input-sm p-3', 'value'=>$item['description']));
																}
																else
																{
																	if ($item['description']!='')
								...
								<div id="overall_sale" class="panel panel-default col-md-3">
									<div class="panel-body">
										<?php
										if(isset($supplier))
										{
										?>
											...
											<?php echo anchor($controller_name."/remove_supplier", '<span class="glyphicon glyphicon-remove">&nbsp</span>' . $this->lang->line('common_remove').' '.$this->lang->line('suppliers_supplier'),
																array('class'=>'btn btn-danger btn-sm btn-block mb-5', 'id'=>'remove_supplier_button', 'title'=>$this->lang->line('common_remove').' '.$this->lang->line('suppliers_supplier'))); ?>
										<?php
										}
										else
										{
