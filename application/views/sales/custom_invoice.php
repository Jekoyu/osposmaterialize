...
<body>
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			<!-- begin breadcrumb -->
			<ol class="breadcrumb pull-right print_hide">
				<li><a href="javascript:;">Beranda</a></li>
				<li><a href="javascript:;">Invoice</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header print_hide">Invoice</h1>
			<!-- end page-header -->
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
							...
							<div class="print_hide" id="control_buttons" style="text-align:right">
								...
								<?php if (isset($customer_email) && !empty($customer_email)) : ?>
									<a href="javascript:void(0);">
										<div class="btn btn-info btn-sm" , id="show_email_button"><?php echo '<span class="glyphicon glyphicon-envelope">&nbsp</span>' . $this->lang->line('sales_send_invoice'); ?></div>
									</a>
								<?php endif; ?>
							...
							<div id="page-wrap">
								...
								<table id="items">
									...
									?>
											<tr class="item-row">
												...
												<?php endif; ?>
												<td class="item-name">
													<div><?php echo ($item['is_serialized'] || $item['allow_alt_description']) && !empty($item['description']) ? $item['description'] : $item['name'] . ' ' . $item['attribute_values']; ?></div>
												</td>
								...
								<table style="width: 100%;margin-top: 30px;" class="no-border">
									<tr>
										<td style="text-align: center;">Penerima Barang</td>
										<td style="text-align: center;">Yang Menyerahkan</td>
									</tr>
									<tr>
										<td style="text-align: center;padding-bottom:3cm;"></td>
										<td style="text-align: center;padding-bottom:3cm;"></td>
									</tr>
								</table>
								...
								<div id="terms">
									<div id="sale_return_policy">
										<h5>
											...
											<?php if (!empty($this->config->item('sales_comments')) || !empty($comments)) { ?><textarea rows="5" cols="6"><?php echo empty($comments) ? '' : $this->lang->line('sales_comments') . ': ' . $comments; ?></textarea> <?php } ?>
