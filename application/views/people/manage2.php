					...
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
							...
							<div id="title_bar" class="btn-toolbar">
								...
								?>
									<button class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url($controller_name . "/csv_import"); ?>' title='<?php echo $this->lang->line('customers_import_items_csv'); ?>'>
